 ...
 */
async function addSourceAttribution(request: AddSourceAttributionRequest, stepConfig: FinalizedStepConfig, verboseLogger?: VerboseLogger): Promise<AddSourceAttributionResponse> {
