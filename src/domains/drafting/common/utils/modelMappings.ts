...
export const MODEL_ALIAS_MAPPING: Record<ModelAlias, ModelAndProviderAndPricing> = {
  ...
  // XAI models
  "grok-4.1-fast": { modelAlias: "grok-4.1-fast", modelId: "grok-4-1-fast", provider: xai, providerId: "xai", inputCostPerMToken: 0.20, outputCostPerMToken: 0.50 },
  "grok-4-fast": { modelAlias: "grok-4-fast", modelId: "grok-4-fast", provider: xai, providerId: "xai", inputCostPerMToken: 0.20, outputCostPerMToken: 0.50 },
